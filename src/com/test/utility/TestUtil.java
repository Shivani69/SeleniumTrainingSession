...
public class TestUtil {
    ...
    public static <reader> ArrayList<Object[]> getDataFromExcel() {
		
    	ArrayList<Object[]> myData = new ArrayList<Object[]>();
		try {
				reader = new Xls_Reader("C:/tools/projects/workspace/JavaTraining/SeleniumTrainingSession/src/com/testdata/HalfEbayTestData.xlsx");
		}catch(Exception e) {
			e.printStackTrace();
